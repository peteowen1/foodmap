...
# michelin skipped: scraper aborts the R process mid-parse on NY's Guide
# (~357 detail pages). Diagnose separately; revisit when fixed.
...
export_diagnostics(all, "output/new_york_diagnostics.csv")
