...
supported_cities_for_source <- function(source) {
  switch(source,
    ...
    infatuation         = c("san-francisco", "honolulu", "new-york",
                            "los-angeles", "london"),
    eater               = c("san-francisco", "new-york", "los-angeles", "london"),
    `7x7`               = "san-francisco",
    cn_traveler         = "san-francisco",
    james_beard         = c("san-francisco", "honolulu", "new-york",
                            "los-angeles"),
    michelin            = c("san-francisco", "new-york", "los-angeles",
                            "london"),
    sprudge             = c("san-francisco", "new-york", "los-angeles",
